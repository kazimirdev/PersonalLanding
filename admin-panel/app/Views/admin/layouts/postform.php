<main class="admin-edit-panel">
    <div class="edit-header">
        <h1><?php echo $isCreateMode ? 'Create Post' : 'Edit Post'; ?></h1>
        <div class="edit-actions">
            <a href="/content" class="btn btn-secondary">← Back to Posts</a>
        </div>
    </div>

    <form method="POST" action="<?php echo $isCreateMode ? '/content/store' : '/content/' . htmlspecialchars($post['id']) . '/update'; ?>" class="edit-form">
        ...
        <section class="form-section form-actions">
            <button type="submit" class="btn btn-primary btn-lg"><?php echo $isCreateMode ? 'Create Post' : 'Update Post'; ?></button>
